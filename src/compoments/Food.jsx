    ...
    <div className='max-w-[1640px] m-auto px-4 py-12'>
      ...
      <div className='flex flex-col lg:flex-row justify-between'>
        ...
        <div>
            ...
            <div className='justify-between max-w-[390px] w-'>
                ...
                <button onClick={()=> filterPrice('$6')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>$6</button>
                ...
                <button onClick={()=> filterPrice('$12')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>$12</button>
            </div>
        </div>
      </div>
